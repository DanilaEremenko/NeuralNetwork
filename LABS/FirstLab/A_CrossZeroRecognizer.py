...
if __name__ == '__main__':
    ...
    # x_pictures = np.array([["Circle.png", "Gimp_Circle.png", "CircleV1.png", "CircleV2.png"],
    #                        ["Cross.png", "Gimp_Cross.png", "CrossV1.png", "CrossV2.png"]])
    ...
    x_test = np.array([get_pxs("CircleV3.png"), get_pxs("CrossV3.png")]).reshape(2, 1024)
    y_test = np.array([0, 1])
